...
import { Typography, Container, TextField, TextareaAutosize, Button, Grid, FormControl, InputLabel, Select, MenuItem, Box } from '@mui/material';
  ...
  return (
    <Box sx={{
      ...
      <Container maxWidth="sm">
        <Box sx={{ background: '#fff', borderRadius: 4, boxShadow: 4, p: { xs: 2, md: 5 } }}>
          ...
          <form>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sx={{ marginBottom: '20px' }}>
                <Button type="submit" variant="contained" color="primary" onClick={handleSubmit} fullWidth sx={{ borderRadius: 2, fontWeight: 600, fontSize: '1.1rem', background: 'linear-gradient(90deg, #1976d2 60%, #00bcd4 100%)', boxShadow: 2, textTransform: 'none' }}>
                  Book Ambulance
                </Button>
              </Grid>
            </Grid>
