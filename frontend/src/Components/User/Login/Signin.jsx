      ...
      <Box sx={{
        ...
        <Container component="main" maxWidth="sm">
          ...
          >
            ...
            <Typography component="h1" variant="h5" sx={{ fontWeight: 700, color: '#1976d2', mb: 2 }}>
              Sign up
            </Typography>
            <Formik
            ...
            >
              ...
              <Grid item xs={12}>
                  ...
                  fullWidth
                  variant="contained"
                  sx={{ mt: 3, mb: 2, borderRadius: 2, fontWeight: 600, fontSize: '1.1rem', background: 'linear-gradient(90deg, #1976d2 60%, #00bcd4 100%)', boxShadow: 2, textTransform: 'none' }}
                >
                  Sign Up
                </Button>
